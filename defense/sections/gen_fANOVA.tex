\begin{frame}{Visualization of MVN Example under Dependence} % How does it look?
    \begin{align*}
...
\begin{align*}
  ...
  \end{align*}
\begin{itemize}
  \item<3-> \textcolor{pastelRed}{$u = \{1\}$ $\rightarrow$ $v \subsetneq u \in \{\emptyset\}$}
  \item<4-> \textcolor{pastelBlue}{$(\emptyset \ne v \subseteq \{1,\dots,N\},\ v \cap u \ne \emptyset,\ v \not\subset u) \in \{\{1,2\}, \{1,3\}, \{1,2,3\}\}$}
\end{itemize}
...
\begin{frame}{Building the Generalized Components as Coupled System}
  ...
  \end{itemize}
    ...
    \end{equation*}
    \begin{itemize}
      \item \textcolor{pastelRed}{$u = \{1\}$ $\rightarrow$ $v \subsetneq u \in \{\emptyset\}$} and \textcolor{pastelBlue}{$(\emptyset \ne v \subseteq \{1,\dots,N\},\ v \cap u \ne \emptyset,\ v \not\subset u) \in \{\{1,2\}, \{1,3\}, \{1,2,3\}\}$}
    \end{itemize}
    \begin{align*}
...
\begin{frame}{Building the Generalized Components as Coupled System}
      \begin{itemize}
      \item \textcolor{pastelRed}{$u = \{1, 2\}$ $\rightarrow$ $v \subsetneq u \in \{\emptyset\,, \{1\}, \{2\}\}$} and \textcolor{pastelBlue}{$(\emptyset \ne v \subseteq \{1,\dots,N\},\ v \cap u \ne \emptyset,\ v \not\subset u) \in \{\{1,2,3\}\}$}
    \end{itemize}
    \begin{align*}
...
\begin{frame}{Building the Generalized Components as Coupled System}
      \begin{itemize}
      \item \textcolor{pastelRed}{$u = \{1, 2, 3\}$ $\rightarrow$ $v \subsetneq u \in \{\emptyset\,, \{1\}, \{2\}, \{3\}, \{1, 2\}, \{1, 3\}, \{2, 3\}\}$} and \textcolor{pastelBlue}{$(\emptyset \ne v \subseteq \{1,\dots,N\},\ v \cap u \ne \emptyset,\ v \not\subset u) \in \{\emptyset\}$}
    \end{itemize}
    \begin{align*}
