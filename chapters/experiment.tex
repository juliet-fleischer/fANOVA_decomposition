...
Recall our running example (\autoref{eq:running_example}):
...
Our running example (\autoref{eq:running_example}) included linear effects of both input variables and the interaction term. For the remainder of this section, we will explore other representative scenarios, we can build within the scaffold of a bivariate two-degree polynomial.
