...
Alternatively we can formulate this via the expected value, throughout it is $\emptyset \neq u \subseteq \{1, \dots, N\}$:
\begin{align*}
    ...
    & = \mathbb{E}[\sum_{u} y_u^2({\boldsymbol{X}_u})]
\end{align*}
