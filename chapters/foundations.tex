...
\begin{itemize}
    \item In ``Sensitivity Estimates for Nonlinear Mathematical Model'' (1993), Sobol first introduces decomposition into summands of different dimensions of a (square) integrable function.
    \item Does not cite Hoeffding nor discuss U-statistics.
    \item``Global sensitivity indices for nonlinear mathematical models and their Monte Carlo estimate'' (2001) builds on his prior work \citep{sobol2001}.
