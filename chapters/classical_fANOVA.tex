...
\begin{proposition}\label{prop:zero_mean_classical}
    Given the strong annihilating conditions are satisfied, the fANOVA component functions $y_u$, where $\, \emptyset \neq u \subseteq \{1, \dots, N\}$, are centered around zero, i.e.,
\begin{equation}
