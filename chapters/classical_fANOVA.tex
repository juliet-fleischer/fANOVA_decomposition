...
\[
 ...
 = \operatorname{Var}\big(h(X_1,X_2)\big).
\]
From an interpretability perspective, the variance decomposition can be interesting, as it allows us to quantify the contribution of each fANOVA component function to the overall variance of the model.
