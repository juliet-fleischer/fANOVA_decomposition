...
% To obtain a decomposition of the desired form, we need a well-thought through setup: we set the strong annihilating conditions.
...
% This setup will allow us to state, that the fANOVA components have 1. zero mean 2. are orthogonal
...
Here could come the proof of existence of Sobol. Now we defined how the decomposition should look like in general and we established the assumptions under which it exists: we set the strong annihilating conditions. Withthese tools we could do the proof of Sobol and arrive at components that have the desired properties.\par
