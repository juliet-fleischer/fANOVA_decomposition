...
% maybe also mention the work that uses fANOVA to make bridges between different theories, e.g. munir, 
% should mention the "Purifying interaction..." paper related to interpretability.
% Lengerich an König