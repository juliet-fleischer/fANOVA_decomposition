...
in this BA we revisit method; clean formal definition into classical and generalized
\end{abstract}
...
\input{chapters/history_fANOVA.tex}
...
\newpage
\section{Estimation of fANOVA}
\label{estimation}
\input{chapters/estimation_fANOVA.tex}
\newpage
\section{Examples \& Visualizations}
\label{example}\input{chapters/example.tex}
\newpage
