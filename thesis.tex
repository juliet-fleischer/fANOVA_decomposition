...
For both cases, we unite different notations and approaches to the formalization of the method. In the final section, we approach fANOVA from a more applied perspective and visualize the decomposition of different functions and provide a conceptual overview of current estimation approaches.
\end{abstract}
