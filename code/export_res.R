...
ggsave("images/experiment_section/hoeffding_rho05_main.png",
       plot = dep_hoeffding_main,
       width = 8, height = 6, dpi = 300, bg = "white")
ggsave("images/experiment_section/hoeffding_rho05_interaction.png",
       plot = dep_hoeffding_interaction,
       width = 8, height = 6, dpi = 300, bg = "white")
